      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto flex min-h-[calc(100vh-200px)] max-w-2xl flex-col items-center justify-center px-6 py-16 text-center">
          ...
          <div className="mt-10 w-full max-w-md space-y-3">
            ...
            <Link
              to="/daftar/aktivasi-gagal"
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl border-2 border-rose-500 bg-background px-6 py-4 text-base font-semibold text-rose-500 transition hover:bg-rose-50"
            >
